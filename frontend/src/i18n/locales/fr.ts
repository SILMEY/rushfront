export default {
  ...
  login: {
    ...
    guest_divider: "ou continuer sans compte",
    guest_label: "Jouer sans se connecter",
    guest_text: "Jouer en invité",
    guest_title: "Choisissez votre nom de commandant",
    guest_pseudo_placeholder: "Votre pseudo (3–20 caractères)",
    guest_play_btn: "Jouer",
    guest_cancel_btn: "Annuler",
