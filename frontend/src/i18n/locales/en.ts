export default {
  ...
  login: {
    ...
    guest_divider: "or continue without an account",
    guest_label: "Play without signing in",
    guest_text: "Play as guest",
    guest_title: "Choose your commander name",
    guest_pseudo_placeholder: "Your username (3–20 characters)",
    guest_play_btn: "Play",
    guest_cancel_btn: "Cancel",
