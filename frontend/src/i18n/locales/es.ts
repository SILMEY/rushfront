export default {
  ...
  login: {
    ...
    guest_divider: "o continuar sin cuenta",
    guest_label: "Jugar sin iniciar sesión",
    guest_text: "Jugar como invitado",
    guest_title: "Elige tu nombre de comandante",
    guest_pseudo_placeholder: "Tu nombre (3–20 caracteres)",
    guest_play_btn: "Jugar",
    guest_cancel_btn: "Cancelar",
