  ...
  <div class="relative mx-auto grid max-w-5xl gap-10 py-10 px-6">
    <section class="relative z-10 mx-auto w-full max-w-xl rounded-2xl border border-white/10 bg-black/40 p-10 backdrop-blur">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
        <button class="group flex flex-col items-center justify-center gap-3 py-4 transition-all duration-300 hover:scale-105 active:scale-95" aria-label="Se connecter avec Google" @click="auth.loginWithGoogle()">
          <div
        ...
        <button class="group flex flex-col items-center justify-center gap-3 py-4 transition-all duration-300 hover:scale-105 active:scale-95" aria-label="Se connecter avec Discord" @click="auth.loginWithDiscord()">
          ...
          <span class="text-[12px] font-bold uppercase tracking-[0.2em] text-slate-200/80">House of Discord</span>
        </button>
      </div>
